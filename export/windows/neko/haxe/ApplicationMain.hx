...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Hogner", "Tp5-Hogner", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "Tp5-Hogner";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Tp5-Hogner", null, { width: 640, height: 480 });
