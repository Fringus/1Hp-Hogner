...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("assets/data/Tp5_level.oep");
		types.push (lime.Assets.AssetType.TEXT);
		
		
		urls.push ("assets/images/Cannon.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/CannonBall.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/characters_7.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/Circular_Saw.png");
		types.push (lime.Assets.AssetType.IMAGE);
		...
		urls.push ("assets/images/sheet_9.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/Simple_Enemy.png");
		types.push (lime.Assets.AssetType.IMAGE);
		...
		urls.push ("assets/images/victoryflag.png");
		types.push (lime.Assets.AssetType.IMAGE);
